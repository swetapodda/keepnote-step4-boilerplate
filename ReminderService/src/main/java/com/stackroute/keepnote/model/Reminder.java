...
public class Reminder {
	...
	public String toString() {
		return String.format(
				"Reminder [reminderId=%s, reminderName=%s, reminderDescription=%s, reminderType=%s, reminderCreatedBy=%s]",
				reminderId, reminderName, reminderDescription, reminderType, reminderCreatedBy);
	    }
