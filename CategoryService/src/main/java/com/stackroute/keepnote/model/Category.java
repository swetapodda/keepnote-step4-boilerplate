...
public class Category {
	...
	public Category(String id, Date categoryCreationDate, String categoryCreatedBy, String categoryDescription,
			String categoryName) {
		this.id = id;
	...
	public String toString() {
		return String.format(
				"Category [id=%s, categoryCreationDate=%s, categoryCreatedBy=%s, categoryDescription=%s, categoryName=%s]",
				id, categoryCreationDate, categoryCreatedBy, categoryDescription, categoryName);
	}
