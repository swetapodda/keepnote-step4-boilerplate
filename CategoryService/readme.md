## Seed code - Boilerplate for step 4 CategoryService - KeepNote Assignment

### Problem Statement

In this case study KeepNote Step 4 - CategoryService, We will write main class for spring boot Application, model class, repository class, service class and interface, logging aspect.
